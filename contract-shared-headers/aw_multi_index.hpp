...
namespace eosio {
    ...
    namespace internal_use_do_not_use {
        extern "C" {
        __attribute__((eosio_wasm_import)) int32_t db_store_i64(
            uint64_t, uint64_t, uint64_t, uint64_t, const void *, uint32_t);

        __attribute__((eosio_wasm_import)) void db_update_i64(int32_t, uint64_t, const void *, uint32_t);
        ...
        __attribute__((eosio_wasm_import)) int32_t db_find_i64(uint64_t, uint64_t, uint64_t, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_lowerbound_i64(uint64_t, uint64_t, uint64_t, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_upperbound_i64(uint64_t, uint64_t, uint64_t, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_end_i64(uint64_t, uint64_t, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_idx64_store(
            uint64_t, uint64_t, uint64_t, uint64_t, const uint64_t *);

        __attribute__((eosio_wasm_import)) void db_idx64_update(int32_t, uint64_t, const uint64_t *);
        ...
        __attribute__((eosio_wasm_import)) int32_t db_idx64_find_primary(
            uint64_t, uint64_t, uint64_t, uint64_t *, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_idx64_find_secondary(
            uint64_t, uint64_t, uint64_t, const uint64_t *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx64_lowerbound(
            uint64_t, uint64_t, uint64_t, uint64_t *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx64_upperbound(
            uint64_t, uint64_t, uint64_t, uint64_t *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx64_end(uint64_t, uint64_t, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_idx128_store(
            uint64_t, uint64_t, uint64_t, uint64_t, const uint128_t *);

        __attribute__((eosio_wasm_import)) void db_idx128_update(int32_t, uint64_t, const uint128_t *);
        ...
        __attribute__((eosio_wasm_import)) int32_t db_idx128_find_primary(
            uint64_t, uint64_t, uint64_t, uint128_t *, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_idx128_find_secondary(
            uint64_t, uint64_t, uint64_t, const uint128_t *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx128_lowerbound(
            uint64_t, uint64_t, uint64_t, uint128_t *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx128_upperbound(
            uint64_t, uint64_t, uint64_t, uint128_t *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx128_end(uint64_t, uint64_t, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_idx256_store(
            uint64_t, uint64_t, uint64_t, uint64_t, const uint128_t *, uint32_t);

        __attribute__((eosio_wasm_import)) void db_idx256_update(int32_t, uint64_t, const uint128_t *, uint32_t);
        ...
        __attribute__((eosio_wasm_import)) int32_t db_idx256_find_primary(
            uint64_t, uint64_t, uint64_t, uint128_t *, uint32_t, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_idx256_find_secondary(
            uint64_t, uint64_t, uint64_t, const uint128_t *, uint32_t, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx256_lowerbound(
            uint64_t, uint64_t, uint64_t, uint128_t *, uint32_t, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx256_upperbound(
            uint64_t, uint64_t, uint64_t, uint128_t *, uint32_t, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx256_end(uint64_t, uint64_t, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_idx_double_store(
            uint64_t, uint64_t, uint64_t, uint64_t, const double *);

        __attribute__((eosio_wasm_import)) void db_idx_double_update(int32_t, uint64_t, const double *);
        ...
        __attribute__((eosio_wasm_import)) int32_t db_idx_double_find_primary(
            uint64_t, uint64_t, uint64_t, double *, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_idx_double_find_secondary(
            uint64_t, uint64_t, uint64_t, const double *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx_double_lowerbound(
            uint64_t, uint64_t, uint64_t, double *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx_double_upperbound(
            uint64_t, uint64_t, uint64_t, double *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx_double_end(uint64_t, uint64_t, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_idx_long_double_store(
            uint64_t, uint64_t, uint64_t, uint64_t, const long double *);

        __attribute__((eosio_wasm_import)) void db_idx_long_double_update(int32_t, uint64_t, const long double *);
        ...
        __attribute__((eosio_wasm_import)) int32_t db_idx_long_double_find_primary(
            uint64_t, uint64_t, uint64_t, long double *, uint64_t);

        __attribute__((eosio_wasm_import)) int32_t db_idx_long_double_find_secondary(
            uint64_t, uint64_t, uint64_t, const long double *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx_long_double_lowerbound(
            uint64_t, uint64_t, uint64_t, long double *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx_long_double_upperbound(
            uint64_t, uint64_t, uint64_t, long double *, uint64_t *);

        __attribute__((eosio_wasm_import)) int32_t db_idx_long_double_end(uint64_t, uint64_t, uint64_t);
        }
    }; // namespace internal_use_do_not_use
...
*/
    ...
    #define WRAP_SECONDARY_SIMPLE_TYPE(IDX, TYPE) \
        ...
        struct secondary_index_db_functions<TYPE> { \
            static int32_t db_idx_next(int32_t iterator, uint64_t *primary) { \
                return internal_use_do_not_use::db_##IDX##_next(iterator, primary); \
            } \
            static int32_t db_idx_previous(int32_t iterator, uint64_t *primary) { \
                return internal_use_do_not_use::db_##IDX##_previous(iterator, primary); \
            } \
            static void db_idx_remove(int32_t iterator) { \
                internal_use_do_not_use::db_##IDX##_remove(iterator); \
            } \
            static int32_t db_idx_end(uint64_t code, uint64_t scope, uint64_t table) { \
                return internal_use_do_not_use::db_##IDX##_end(code, scope, table); \
            } \
            static int32_t db_idx_store( \
                uint64_t scope, uint64_t table, uint64_t payer, uint64_t id, const TYPE &secondary) { \
            ...
            static int32_t db_idx_find_primary( \
                uint64_t code, uint64_t scope, uint64_t table, uint64_t primary, TYPE &secondary) { \
                return internal_use_do_not_use::db_##IDX##_find_primary(code, scope, table, &secondary, primary); \
            } \
            static int32_t db_idx_find_secondary( \
                uint64_t code, uint64_t scope, uint64_t table, const TYPE &secondary, uint64_t &primary) { \
                return internal_use_do_not_use::db_##IDX##_find_secondary(code, scope, table, &secondary, &primary); \
            } \
            static int32_t db_idx_lowerbound( \
                uint64_t code, uint64_t scope, uint64_t table, TYPE &secondary, uint64_t &primary) { \
                return internal_use_do_not_use::db_##IDX##_lowerbound(code, scope, table, &secondary, &primary); \
            } \
            static int32_t db_idx_upperbound( \
                uint64_t code, uint64_t scope, uint64_t table, TYPE &secondary, uint64_t &primary) { \
    ...
    #define WRAP_SECONDARY_ARRAY_TYPE(IDX, TYPE) \
        ...
        struct secondary_index_db_functions<TYPE> { \
            ...
            static int32_t db_idx_store( \
                uint64_t scope, uint64_t table, uint64_t payer, uint64_t id, const TYPE &secondary) { \
                return internal_use_do_not_use::db_##IDX##_store( \
                    scope, table, payer, id, secondary.data(), TYPE::num_words()); \
            } \
            static void db_idx_update(int32_t iterator, uint64_t payer, const TYPE &secondary) { \
            ...
            static int32_t db_idx_find_primary( \
                uint64_t code, uint64_t scope, uint64_t table, uint64_t primary, TYPE &secondary) { \
                return internal_use_do_not_use::db_##IDX##_find_primary( \
                    code, scope, table, secondary.data(), TYPE::num_words(), primary); \
            } \
            static int32_t db_idx_find_secondary( \
                uint64_t code, uint64_t scope, uint64_t table, const TYPE &secondary, uint64_t &primary) { \
                return internal_use_do_not_use::db_##IDX##_find_secondary( \
                    code, scope, table, secondary.data(), TYPE::num_words(), &primary); \
            } \
            static int32_t db_idx_lowerbound( \
                uint64_t code, uint64_t scope, uint64_t table, TYPE &secondary, uint64_t &primary) { \
                return internal_use_do_not_use::db_##IDX##_lowerbound( \
                    code, scope, table, secondary.data(), TYPE::num_words(), &primary); \
            } \
            static int32_t db_idx_upperbound( \
                uint64_t code, uint64_t scope, uint64_t table, TYPE &secondary, uint64_t &primary) { \
                return internal_use_do_not_use::db_##IDX##_upperbound( \
                    code, scope, table, secondary.data(), TYPE::num_words(), &primary); \
            } \
        };
    ...
    #define MAKE_TRAITS_FOR_ARITHMETIC_SECONDARY_KEY(TYPE) \
        ...
        struct secondary_key_traits<TYPE> { \
            ...
            static constexpr TYPE true_lowest() { \
    ...
    */
    /**
     * The indexed_by struct is used to instantiate the indices for the Multi-Index table. In EOSIO, up to 16 secondary
     * indices can be specified.
     *
     * @ingroup multiindex
     * @tparam IndexName - is the name of the index. The name must be provided as an EOSIO base32 encoded 64-bit integer
     * and must conform to the EOSIO naming requirements of a maximum of 13 characters, the first twelve from the
     * lowercase characters a-z, digits 1-5, and ".", and if there is a 13th character, it is restricted to lowercase
     * characters a-p and ".".
     * @tparam Extractor - is a function call operator that takes a const reference to the table object type and returns
     * either a secondary key type or a reference to a secondary key type. It is recommended to use the
     * `eosio::const_mem_fun` template, which is a type alias to the `boost::aw_multi_index::const_mem_fun`. See the
     * documentation for the Boost `const_mem_fun` key extractor for more details.
     *
     * Example:
     *
     *
     ...
     *       auto code = _self;
     *       auto scope = _self;
     *       aw_multi_index<"mytable"_n, record,
     *                  indexed_by< "bysecondary"_n, const_mem_fun<record, uint128_t, &record::get_secondary> > > table(
     * code, scope);
     *     }
     * }
    ...
    /**
     * @ingroup awmultiindex
     *
     * @brief Defines EOSIO Multi Index Table
     * @details EOSIO Multi-Index API provides a C++ interface to the EOSIO database. It is patterned after Boost Multi
     * Index Container. EOSIO Multi-Index table requires exactly a uint64_t primary key. For the table to be able to
     * retrieve the primary key, the object stored inside the table is required to have a const member function called
     * primary_key() that returns uint64_t. EOSIO Multi-Index table also supports up to 16 secondary indices. The type
     * of the secondary indices could be any of:
     * - uint64_t
     * - uint128_t
     * - double
     * - long double
    ...
    class aw_multi_index {
      private:
        static_assert(sizeof...(Indices) <= 16, "aw_multi_index only supports a maximum of 16 secondary indices");

        constexpr static bool validate_table_name(name n) {
            // Limit table names to 12 characters so that the last character (4 bits) can be used to distinguish between
        ...
        static_assert(validate_table_name(name(TableName)),
            "aw_multi_index does not support table names with a length greater than 12");
        ...
        enum next_primary_key_tags : uint64_t {
            no_available_primary_key =
                static_cast<uint64_t>(-2), // Must be the smallest uint64_t value compared to all other tags
            unset_next_primary_key = static_cast<uint64_t>(-1)
        };

        struct item : public T {
            template <typename Constructor>
            item(const aw_multi_index *idx, Constructor &&c) : __idx(idx) {
                c(*this);
            }

            const aw_multi_index *__idx;
        ...
        struct index {
          public:
            ...
            static_assert(validate_index_name(name(IndexName)), "invalid index name used in aw_multi_index");
            ...
            constexpr static uint64_t number() {
                return Number;
            }
            ...
            struct const_iterator : public std::iterator<std::bidirectional_iterator_tag, const T> {
              public:
                ...
                const_iterator &operator++() {
                    ...
                    if (_item->__iters[Number] == -1) {
                        ...
                        auto idxitr = secondary_index_db_functions<secondary_key_type>::db_idx_find_primary(
                            _idx->get_code().value, _idx->get_scope(), _idx->name(), _item->primary_key(),
                            temp_secondary_key);
                    ...
                    uint64_t next_pk = 0;
                    auto     next_itr =
                        secondary_index_db_functions<secondary_key_type>::db_idx_next(_item->__iters[Number], &next_pk);
                    if (next_itr < 0) {
                        _item = nullptr;
                        return *this;
                    }
                ...
                const_iterator &operator--() {
                    ...
                    if (!_item) {
                        auto ei = secondary_index_db_functions<secondary_key_type>::db_idx_end(
                            _idx->get_code().value, _idx->get_scope(), _idx->name());
                        ...
                        prev_itr = secondary_index_db_functions<secondary_key_type>::db_idx_previous(
                            _item->__iters[Number], &prev_pk);
              ...
              private:
                friend struct index;
                const_iterator(const index *idx, const item *i = nullptr) : _idx(idx), _item(i) {}

                const index *_idx;
                const item * _item;
            }; /// struct aw_multi_index::index::const_iterator
            ...
            const_iterator require_find(
                secondary_key_type &&secondary, const char *error_msg = "unable to find secondary key") const {
                return require_find(secondary, error_msg);
            }

            const_iterator require_find(
                const secondary_key_type &secondary, const char *error_msg = "unable to find secondary key") const {
                auto lb = lower_bound(secondary);
            ...
            const_iterator lower_bound(const secondary_key_type &secondary) const {
                ...
                auto               itr = secondary_index_db_functions<secondary_key_type>::db_idx_lowerbound(
                    get_code().value, get_scope(), name(), secondary_copy, primary);
                if (itr < 0)
                    return cend();
            ...
            const_iterator upper_bound(const secondary_key_type &secondary) const {
                ...
                uint64_t           primary = 0;
                secondary_key_type secondary_copy(secondary);
                auto               itr = secondary_index_db_functions<secondary_key_type>::db_idx_upperbound(
                    get_code().value, get_scope(), name(), secondary_copy, primary);
                if (itr < 0)
                    return cend();
            ...
            const_iterator iterator_to(const T &obj) {
                ...
                eosio::check(objitem.__idx == _multidx, "object passed to iterator_to is not in aw_multi_index");
          ...
          private:
            friend class aw_multi_index;

            index(typename std::conditional<IsConst, const aw_multi_index *, aw_multi_index *>::type midx)
                : _multidx(midx) {}

            typename std::conditional<IsConst, const aw_multi_index *, aw_multi_index *>::type _multidx;
        }; /// struct aw_multi_index::index
        ...
        static constexpr auto transform_indices() {
            ...
            typedef decltype(hana::zip_shortest(
                hana::make_tuple(intc<0>(), intc<1>(), intc<2>(), intc<3>(), intc<4>(), intc<5>(), intc<6>(), intc<7>(),
                    intc<8>(), intc<9>(), intc<10>(), intc<11>(), intc<12>(), intc<13>(), intc<14>(), intc<15>()),
            ...
            return hana::transform(indices_input_type(), [&](auto &&idx) {
                ...
                return hana::make_tuple(
                    hana::type_c<index<eosio::name::raw(static_cast<uint64_t>(idx_type::index_name)),
                        typename idx_type::secondary_extractor_type, num_type::e::value, false>>,
                    hana::type_c<index<eosio::name::raw(static_cast<uint64_t>(idx_type::index_name)),
                        typename idx_type::secondary_extractor_type, num_type::e::value, true>>);
            });
        }

        typedef decltype(aw_multi_index::transform_indices()) indices_type;
      ...
      public:
         ...
         * @post Secondary indices are updated to refer to the newly added object. If the secondary index tables do not
         * exist, they are created.
         * @post The payer is charged for the storage usage of the new object and, if the table (and secondary index
         * tables) must be created, for the overhead of the table creation.
         *
         * Notes
         * The `eosio::aw_multi_index` template has template parameters `<name::raw TableName, typename T, typename...
         * Indices>`, where:
         * - `TableName` is the name of the table, maximum 12 characters long, characters in the name from the set of
         * lowercase letters, digits 1 to 5, and the "." (period) character and is converted to a eosio::raw - which
         * wraps uint64_t;
         ...
         * - Each must have a function call operator that takes a const reference to the table object type and returns
         * either a secondary key type or a reference to a secondary key type
         * - It is recommended to use the eosio::const_mem_fun template, which is a type alias to the
         * boost::aw_multi_index::const_mem_fun.  See the documentation for the Boost const_mem_fun key extractor for
         * more details.
         *
         * Example:
         *
         ...
         *     typedef eosio::aw_multi_index< "address"_n, address > address_index;
         *     void myaction() {
         ...
         * @endcode
         */
        aw_multi_index(name code, uint64_t scope)
         ...
         * @ingroup multiindex
         *
         * @return Scope id of the Scope within the Code of the Current Receiver under which the desired Primary Table
        ...
        struct const_iterator : public std::iterator<std::bidirectional_iterator_tag, const T> {
            ...
            const_iterator &operator--() {
                ...
                if (!_item) {
                    auto ei = internal_use_do_not_use::db_end_i64(
                        _multidx->get_code().value, _multidx->get_scope(), static_cast<uint64_t>(TableName));
          ...
          private:
            const_iterator(const aw_multi_index *mi, const item *i = nullptr) : _multidx(mi), _item(i) {}

            const aw_multi_index *_multidx;
            const item *          _item;
            friend class aw_multi_index;
        }; /// struct aw_multi_index::const_iterator
        ...
        /**
         * Returns an iterator referring to the `past-the-end` element in the multi index container. The `past-the-end`
         * element is the theoretical element that would follow the last element in the vector. It does not point to any
        ...
        /**
         * Returns a reverse iterator pointing to the `object_type` with the highest primary key value in the
         * Multi-Index table.
         * @ingroup multiindex
         *
         * @return A reverse iterator pointing to the `object_type` with the highest primary key value in the
         * Multi-Index table.
         *
         * Example:
         *
        ...
        /**
         * Searches for the `object_type` with the lowest primary key that is greater than or equal to a given primary
         * key.
         * @ingroup multiindex
         *
         * @param primary - Primary key that establishes the target value for the lower bound search.
         * @return An iterator pointing to the `object_type` that has the lowest primary key that is greater than or
         * equal to `primary`. If an object could not be found, or if the table does not exist**, it will return the
         * `end` iterator.
         *
         * Example:
         *
        ...
        const_iterator lower_bound(uint64_t primary) const {
            auto itr = internal_use_do_not_use::db_lowerbound_i64(
                _code.value, _scope, static_cast<uint64_t>(TableName), primary);
            if (itr < 0)
                return end();
         ...
         * @return An iterator pointing to the `object_type` that has the lowest primary key that is greater than a
         * given `primary` key. If an object could not be found, or if the table does not exist**, it will return the
         * `end` iterator.
         *
         * Example:
         *
        ...
        const_iterator upper_bound(uint64_t primary) const {
            auto itr = internal_use_do_not_use::db_upperbound_i64(
                _code.value, _scope, static_cast<uint64_t>(TableName), primary);
            if (itr < 0)
                return end();
            const auto &obj = load_object_by_primary_iterator(itr);
         ...
         *
         * Notes:
         * Intended to be used in tables in which the primary keys of the table are strictly intended to be
         * auto-incrementing, and thus will never be set to custom values by the contract.  Violating this expectation
         * could result in the table appearing to be full due to inability to allocate an available primary key. Ideally
         * this method would only be used to determine the appropriate primary key to use within new objects added to a
         * table in which the primary keys of the table are strictly intended from the beginning to be autoincrementing
         * and thus will not ever be set to custom arbitrary values by the contract. Violating this agreement could
         * result in the table appearing full when in reality there is plenty of space left.
         *
         * Example:
         *
         * @code
        ...
        uint64_t available_primary_key() const {
            if (_next_primary_key == unset_next_primary_key) {
                // This is the first time available_primary_key() is called for this aw_multi_index instance.
            ...
            eosio::check(
                _next_primary_key < no_available_primary_key, "next primary key in table is at autoincrement limit");
         ...
         *
         * @return An index of the appropriate type: Primitive 64-bit unsigned integer key (idx64), Primitive 128-bit
         * unsigned integer key (idx128), 128-bit fixed-size lexicographical key (idx128), 256-bit fixed-size
         * lexicographical key (idx256), Floating point key, Double precision floating point key, Long Double
         ...
         *     typedef eosio::aw_multi_index< name("address"), address, indexed_by< name("zip"), const_mem_fun<address,
         * uint64_t, &address::by_zip> > address_index; void myaction() {
         *       // create reference to address_index  - see emplace example below
         *       // add dan account to table           - see emplace example below
        ...
        auto get_index() {
            ...
            auto res = hana::find_if(_indices, [](auto &&in) {
                return std::integral_constant<bool,
                    static_cast<uint64_t>(std::decay<typename decltype(+hana::at_c<0>(in))::type>::type::index_name) ==
                        static_cast<uint64_t>(IndexName)>();
            });

            static_assert(
                res != hana::nothing, "name provided is not the name of any secondary index within aw_multi_index");
        ...
        auto get_index() const {
            ...
            auto res = hana::find_if(_indices, [](auto &&in) {
                return std::integral_constant<bool,
                    static_cast<uint64_t>(std::decay<typename decltype(+hana::at_c<1>(in))::type>::type::index_name) ==
                        static_cast<uint64_t>(IndexName)>();
            });
        ...
        const_iterator iterator_to(const T &obj) const {
            const auto &objitem = static_cast<const item &>(obj);
            eosio::check(objitem.__idx == this, "object passed to iterator_to is not in aw_multi_index");
            return {this, &objitem};
        }
        /**
         ...
         * @param constructor - Lambda function that does an in-place initialization of the object to be created in the
         * table
         *
         * @pre A multi index table has been instantiated
         * @post A new object is created in the Multi-Index table, with a unique primary key (as specified in the
         * object).  The object is serialized and written to the table. If the table does not exist, it is created.
         * @post Secondary indices are updated to refer to the newly added object. If the secondary index tables do not
         * exist, they are created.
         * @post The payer is charged for the storage usage of the new object and, if the table (and secondary index
         * tables) must be created, for the overhead of the table creation.
        ...
        const_iterator emplace(name payer, Lambda &&constructor) {
            ...
            eosio::check(_code == current_receiver(),
                "cannot create objects in table of another contract"); // Quick fix for mutating db using aw_multi_index
                                                                       // that shouldn't allow mutation. Real fix can
                                                                       // come in RC2.
            ...
            auto itm = std::make_unique<item>(this, [&](auto &i) {
                ...
                i.__primary_itr = internal_use_do_not_use::db_store_i64(
                    _scope, static_cast<uint64_t>(TableName), payer.value, pk, buffer, size);
                ...
                hana::for_each(_indices, [&](auto &idx) {
                    ...
                    i.__iters[index_type::number()] =
                        secondary_index_db_functions<typename index_type::secondary_key_type>::db_idx_store(_scope,
                            index_type::name(), payer.value, obj.primary_key(), index_type::extract_secondary_key(obj));
                });
            });
         ...
         * @post If payer is the same as the existing payer, payer only pays for the usage difference between existing
         * and updated object (and is refunded if this difference is negative).
         * @post If payer is different from the existing payer, the existing payer is refunded for the storage usage of
         * the existing object.
         *
         * Exceptions:
        ...
        void modify(const T &obj, name payer, Lambda &&updater) {
            ...
            const auto &objitem = static_cast<const item &>(obj);
            eosio::check(objitem.__idx == this, "object passed to modify is not in aw_multi_index");
            auto &mutableitem = const_cast<item &>(objitem);
            eosio::check(_code == current_receiver(),
                "cannot modify objects in table of another contract"); // Quick fix for mutating db using aw_multi_index
                                                                       // that shouldn't allow mutation. Real fix can
                                                                       // come in RC2.
            ...
            auto &mutableobj = const_cast<T &>(
                obj); // Do not forget the auto& otherwise it would make a copy and thus not update at all.
            updater(mutableobj);
                ...
                if (memcmp(&hana::at_c<index_type::index_number>(secondary_keys), &secondary, sizeof(secondary)) != 0) {
                    ...
                    if (indexitr < 0) {
                        ...
                        indexitr = mutableitem.__iters[index_type::number()] =
                            secondary_index_db_functions<typename index_type::secondary_key_type>::db_idx_find_primary(
                                _code.value, _scope, index_type::name(), pk, temp_secondary_key);
                    }
         ...
         *
         * @param primary - Primary key value of the object
         * @return An iterator to the found object which has a primary key equal to `primary` OR the `end` iterator of
         * the referenced table if an object with primary key `primary` is not found.
         *
         * Example:
         *
         * @code
        ...
        const_iterator find(uint64_t primary) const {
            ...
            auto itr =
                internal_use_do_not_use::db_find_i64(_code.value, _scope, static_cast<uint64_t>(TableName), primary);
            if (itr < 0)
                return end();
         ...
         * @return An iterator to the found object which has a primary key equal to `primary` OR throws an exception if
         * an object with primary key `primary` is not found.
         */
         ...
         * @post The existing payer for storage usage of the object is refunded for the table and secondary indices
         * usage of the removed object, and if the table and indices are removed, for the associated overhead.
         *
         * @return For the signature with `const_iterator`, returns a pointer to the object following the removed
         * object.
         *
         * Exceptions:
        ...
        void erase(const T &obj) {
            ...
            const auto &objitem = static_cast<const item &>(obj);
            eosio::check(objitem.__idx == this, "object passed to erase is not in aw_multi_index");
            eosio::check(_code == current_receiver(),
                "cannot erase objects in table of another contract"); // Quick fix for mutating db using aw_multi_index
                                                                      // that shouldn't allow mutation. Real fix can
                                                                      // come in RC2.
            ...
            eosio::check(itr2 != _items_vector.rend(), "attempt to remove object that was not in aw_multi_index");
            ...
            hana::for_each(_indices, [&](auto &idx) {
                ...
                if (i < 0) {
                    ...
                    i = secondary_index_db_functions<typename index_type::secondary_key_type>::db_idx_find_primary(
                        _code.value, _scope, index_type::name(), objitem.primary_key(), secondary);
                }
                if (i >= 0)
        ...
        void blind_erase_begin() {
            ...
            //     return ptr._item->primary_key() == pk;
            // });
            auto itr2 = _items_vector.begin();

            eosio::check(itr2 != _items_vector.rend(), "attempt to remove object that was not in aw_multi_index");

            internal_use_do_not_use::db_remove_i64(itr2);

            hana::for_each(_indices, [&](auto &idx) {
                typedef typename decltype(+hana::at_c<0>(idx))::type index_type;

                auto i = _indices[index_type::number()];
                if (i < 0) {
                    typename index_type::secondary_key_type secondary;
                    i = secondary_index_db_functions<typename index_type::secondary_key_type>::db_idx_find_primary(
                        _code.value, _scope, index_type::name(), itr2, secondary);
                }
                if (i >= 0)
                    secondary_index_db_functions<typename index_type::secondary_key_type>::db_idx_remove(i);
            });

            // _items_vector.erase(--itr2);
        }
    };
} // namespace eosio
